...
A simple and convenient binary date & time format in 64 bits. Date values are directly comparable, and the standard Gregorian fields are easily extractable.
